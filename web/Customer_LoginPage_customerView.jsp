...
<%
    ...
    if (session.getAttribute("customer") != null) {
        ...
        response.sendRedirect("Admin_editProfile-adminView.jsp");
    }
%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Login Customer - Fast & Fashion</title>
                                    ...
                                    <div class="tab-pane fade show active" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
                                        <form action="LoginController" method="get">
                                            <div class="form-group">
                                                <label for="singin-username-2">Username</label>
                                                <input type="text" class="form-control" id="singin-email-2" name="signin-username">
                                                <%
                                                    int count = 0;
                                                    if(count == 0){
                                                        %>
                                                            <small style="color: red">${loginUsernameErrMsg}</small>
                                                        <%
                                                    }
                                                %>
                                            </div><!-- End .form-group -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small style="color: red">${loginPasswordErrMsg}</small>
                                            </div><!-- End .form-group -->
                                            ...
                                            <div class="form-footer">
                                                ...
                                                <a href="Customer_ForgotPassword-customerView.jsp" class="forgot-link">Forgot Your Password?</a>
                                            </div><!-- End .form-footer -->
                                        </form>

                                    </div><!-- .End .tab-pane -->
                                    <div class="tab-pane fade" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                                        <form method="get" action="RegisterCustomerController">
                                            <div class="form-group">
                                                <label for="register-username">Username *</label>
                                                <input type="text" class="form-control" id="register-username" name="register-username">
                                                <small style="color: red">${registerUsernameErrMsg}</small>
                                            </div><!-- End .form-group -->

                                            <div class="form-group">
                                                <label for="register-phoneNum">Phone Number *</label>
                                                <input type="tel" class="form-control" id="register-phoneNum" name="register-phoneNum">
                                                <small style="color: red">${registerPhoneNumErrMsg}</small>
                                            </div><!-- End .form-group -->

                                            <div class="form-group">
                                                <label for="register-email">Your email address *</label>
                                                <input type="text" class="form-control" id="register-email" name="register-email">
                                                <small style="color: red">${registerEmailErrMsg}</small>
                                            </div><!-- End .form-group -->

                                            <div class="form-group">
                                                <label for="register-password">Password *</label>
                                                <input type="password" class="form-control" id="register-password" name="register-password">
                                                <small style="color: red">${registerPasswordErrMsg}</small>
                                            </div><!-- End .form-group -->
